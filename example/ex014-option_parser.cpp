...
int main(int argc, char *argv[])
{
    ...
    try {
        ...
        args.add_countable_flag(cfg.verbose, 'v', "verbose")
            .set_description("Show verbose output, set more times to increase "
                             "verbose level");
        ...
        args.add_data_unit(cfg.data_unit, 'd', "data-unit", false,
                           "Set data unit")
        ...
        args.set_more_usage(
            {"ANYTHING MORE",
             "    There are more content on usage page, you can write anything "
             "here,",
             "    and there is no extra indent, you should do it yourself.", "",
             "COPYRIGHT", "    Copyright (c) 2024 The Author's name.", "",
             "This page is generated by option parser. Thanks for using this "
             "software."});
